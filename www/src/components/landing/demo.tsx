...
export function Demo() {
  ...
  return (
    <section ref={ref} className="flex flex-col items-center px-4 py-16 md:py-24">
      ...
      >
        Pulsar analyzes your TypeScript + Prisma schema in a unified pipeline. One command, zero
        config.
      </motion.p>
      ...
      <div className="mt-10 grid gap-4 w-full max-w-4xl md:grid-cols-2">
        ...
        >
          <DynamicCodeBlock
            lang="ts"
            code={codeBefore}
            codeblock={{ className: "border-none ring-0 shadow-none" }}
          />
        </motion.div>
      ...
      >
        <Link to="/docs/guide/getting-started">
          <Button size="lg">Start analyzing your code</Button>
        </Link>
      </motion.div>
    </section>
  );
